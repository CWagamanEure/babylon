...
description: Adversarial auditor for the data layer — exact-decimal handling, partition globs, sentinel/flag predicates, ingest crash-safety, ledger transition classification, carry-seed correctness. Use on research/data (schema, db, ingest, ledger, episodes_build) and any query/ETL code.
